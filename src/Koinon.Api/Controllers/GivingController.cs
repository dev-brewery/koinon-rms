    ...
    ILogger<GivingController> logger) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="ct">Cancellation token</param>
    /// <returns>List of all funds with full admin detail</returns>
    /// <response code="200">Returns list of all funds</response>
    [HttpGet("admin/funds")]
    [RequiresClaim("financial", "view")]
    ...
    /// <response code="200">Fund updated successfully</response>
    /// <response code="400">Invalid request</response>
    /// <response code="404">Fund not found</response>
    [HttpPut("admin/funds/{idKey}")]
    [ValidateIdKey]
    [RequiresClaim("financial", "edit")]
    ...
    /// <response code="204">Fund deactivated successfully</response>
    /// <response code="404">Fund not found</response>
    [HttpDelete("admin/funds/{idKey}")]
    [ValidateIdKey]
    [RequiresClaim("financial", "edit")]
