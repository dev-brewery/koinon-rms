...
namespace Koinon.Infrastructure.Migrations
{
    ...
    [Migration("20251209064650_AddGroupMeetingRsvp")]
    partial class AddGroupMeetingRsvp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.GroupMeetingRsvp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime?>("RespondedDateTime")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("GroupId", "MeetingDate", "PersonId")
                        .IsUnique()
                        .HasDatabaseName("uix_group_meeting_rsvp_group_meeting_person");

                    b.ToTable("group_meeting_rsvp", (string)null);
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.VolunteerScheduleAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("GroupMemberId", "ScheduleId", "AssignedDate")
                        .IsUnique()
                        .HasDatabaseName("uix_volunteer_schedule_assignment_member_schedule_date");

                    b.ToTable("volunteer_schedule_assignment", (string)null);
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.VolunteerScheduleAssignment", b =>
                {
                    b.HasOne("Koinon.Domain.Entities.GroupMember", "GroupMember")
                        .WithMany()
