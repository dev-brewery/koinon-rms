...
namespace Koinon.Infrastructure.Migrations
{
    ...
    [Migration("20260327153314_SeedNoteTypeDefinedType")]
    partial class SeedNoteTypeDefinedType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.ContributionStatement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("BinaryFileId");

                    b.HasIndex("Guid")
                        .IsUnique()
                        .HasDatabaseName("ix_contribution_statement_guid");
                    ...
                    b.ToTable("contribution_statement", (string)null);
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.LabelTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("AuthorPersonAliasId")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("NoteTypeValueId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("AuthorPersonAliasId");

                    b.HasIndex("Guid")
                        .IsUnique()
                        .HasDatabaseName("uix_note_guid");

                    b.HasIndex("NoteTypeValueId")
                        .HasDatabaseName("ix_note_note_type_value_id");

                    b.HasIndex("PersonAliasId", "NoteDateTime")
                        .HasDatabaseName("ix_note_person_alias_id_note_date_time");

                    b.ToTable("note", (string)null);
                });

            modelBuilder.Entity("Koinon.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("PersonId", "NotificationType")
                        .IsUnique()
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.Person", b =>
                {
                    ...
                    b.HasIndex("MaritalStatusValueId");
                    ...
                    b.HasIndex("SuffixValueId");

                    b.HasIndex("TitleValueId");
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.PersonDuplicateIgnore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("MarkedByPersonId")
                        .HasColumnType("integer")
                    ...
                    b.ToTable("person_duplicate_ignore", (string)null);
                });

            modelBuilder.Entity("Koinon.Domain.Entities.PersonMergeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("MergedByPersonId")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("SurvivorPersonId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("MergedByPersonId");

                    b.HasIndex("MergedDateTime")
                    ...
                    b.HasIndex("SurvivorPersonId")
                        .HasDatabaseName("ix_person_merge_history_survivor_person_id");

                    b.ToTable("person_merge_history", (string)null);
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.ReportDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("report_definition", (string)null);
                });

            modelBuilder.Entity("Koinon.Domain.Entities.ReportRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("report_run", (string)null);
                });

            modelBuilder.Entity("Koinon.Domain.Entities.ReportSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("RecipientPersonAliasIds")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("report_schedule", (string)null);
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.TwoFactorConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("two_factor_config", (string)null);
                });

            modelBuilder.Entity("Koinon.Domain.Entities.UserPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.ContributionStatement", b =>
                {
                    b.HasOne("Koinon.Domain.Entities.BinaryFile", "BinaryFile")
                        .WithMany()
                        .HasForeignKey("BinaryFileId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.Note", b =>
                {
                    b.HasOne("Koinon.Domain.Entities.PersonAlias", "AuthorPersonAlias")
                        .WithMany()
                        .HasForeignKey("AuthorPersonAliasId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Koinon.Domain.Entities.DefinedValue", "NoteTypeValue")
                        .WithMany()
                        .HasForeignKey("NoteTypeValueId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("AuthorPersonAlias");

                    b.Navigation("NoteTypeValue");
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.Person", b =>
                {
                    ...
                    b.HasOne("Koinon.Domain.Entities.DefinedValue", "MaritalStatusValue")
                        .WithMany()
                        .HasForeignKey("MaritalStatusValueId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Koinon.Domain.Entities.DefinedValue", "SuffixValue")
                        .WithMany()
                        .HasForeignKey("SuffixValueId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Koinon.Domain.Entities.DefinedValue", "TitleValue")
                        .WithMany()
                        .HasForeignKey("TitleValueId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ConnectionStatusValue");

                    b.Navigation("MaritalStatusValue");
                    ...
                    b.Navigation("SuffixValue");

                    b.Navigation("TitleValue");
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.PersonDuplicateIgnore", b =>
                {
                    b.HasOne("Koinon.Domain.Entities.Person", "MarkedByPerson")
                        .WithMany()
                        .HasForeignKey("MarkedByPersonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Koinon.Domain.Entities.Person", "Person1")
                        .WithMany()
                        .HasForeignKey("PersonId1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Koinon.Domain.Entities.Person", "Person2")
                        .WithMany()
                        .HasForeignKey("PersonId2")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MarkedByPerson");
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.PersonMergeHistory", b =>
                {
                    b.HasOne("Koinon.Domain.Entities.Person", "MergedByPerson")
                        .WithMany()
                        .HasForeignKey("MergedByPersonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Koinon.Domain.Entities.Person", "MergedPerson")
                        .WithMany()
                        .HasForeignKey("MergedPersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Koinon.Domain.Entities.Person", "SurvivorPerson")
                        .WithMany()
                        .HasForeignKey("SurvivorPersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MergedByPerson");

                    b.Navigation("MergedPerson");

                    b.Navigation("SurvivorPerson");
                });
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.ReportRun", b =>
                {
                    ...
                    b.HasOne("Koinon.Domain.Entities.ReportDefinition", "ReportDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("Koinon.Domain.Entities.UserSession", b =>
                {
                    ...
                    b.HasOne("Koinon.Domain.Entities.RefreshToken", "RefreshToken")
                        .WithMany()
