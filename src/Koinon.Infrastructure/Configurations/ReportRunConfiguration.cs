...
/// <summary>
/// Entity Framework Core configuration for the ReportRun entity.
/// </summary>
public class ReportRunConfiguration : IEntityTypeConfiguration<ReportRun>
{
    public void Configure(EntityTypeBuilder<ReportRun> builder)
    {
        ...
        builder.HasIndex(e => e.Guid)
            .IsUnique()
            .HasDatabaseName("uix_report_run_guid");
        ...
        // Indexes
        builder.HasIndex(e => new { e.ReportDefinitionId, e.Status })
            .HasDatabaseName("ix_report_run_report_definition_id_status");

        builder.HasIndex(e => e.Status)
            .HasDatabaseName("ix_report_run_status");
    }
}
